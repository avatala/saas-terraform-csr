...
private_dns_prefix_path = "gcp-deployment/terraform/env/${PREFIX}/global/cloud-dns/private-dns"
...
lb_prefix_path = "gcp-deployment/terraform/env/${PREFIX}/global/networking/https-lb"