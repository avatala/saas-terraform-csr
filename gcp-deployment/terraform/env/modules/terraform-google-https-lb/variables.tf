...
variable "master_cf_ip" {
  type        = string
  description = "Name of IP for master cloud function"
}

variable "email_verification_ip" {
  type        = string
  description = "Name of IP for Email verification cloud function"
}

variable "gcip_ip" {
  type        = string
  description = "Name of IP for Cloud run GCIP"
}

variable "email_verification_cert" {
  type        = string
  description = "Name of the certificate for Email verification cloud function"

}

variable "email_verification" {
  type        = list(string)
  description = "Name of the domain for Email verification cloud function"
}

variable "master_cf_cert" {
  type        = string
  description = "Name of the certificate for master cloud function"
}

variable "master_cf" {
  type        = list(string)
  description = "Name of the domain for master cloud function"
}

variable "gcip_cert" {
  type        = string
  description = "Name of the certificate for Cloud run GCIP"
}

variable "gcip" {
  type        = list(string)
  description = "Name of the domain for Cloud run GCIP"
}
