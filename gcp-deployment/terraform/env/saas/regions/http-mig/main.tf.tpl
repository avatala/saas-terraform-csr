...
module "instance_template" {
  ...
  startup_script       = file("./scripts/freemium-nginx.sh")
  service_account = {
    email  = "PREFIX_NAME-mig-sa@${data.terraform_remote_state.host_project_id.outputs.standalone_projects.standalone_project_01["project_id"]}.iam.gserviceaccount.com"
